...
//PersonaServices servicio;
    ...
    public ResponseEntity<?> getAll(){
        try{
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"error\":\"Error, por favor intente más tarde\"}");//Formato Json
        }
    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getOne(@PathVariable Long id){ //PathVariable dice que va a estar en la busqueda
        try{
